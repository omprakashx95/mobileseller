...
import com.example.omprakash.apk.fragments.HomeFragment;
import com.example.omprakash.apk.fragments.ReplacementFragment;
...
public class Home extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Brand1Fragment(), "BRANDS");
